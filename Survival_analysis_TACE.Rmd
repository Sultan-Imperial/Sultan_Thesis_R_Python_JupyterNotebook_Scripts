...
# [) ✍️ Introduction to HCC and TACE-based treatment]{style="color:#000000; font-weight:bold;"} {.tabset .tabset-fade .tabset-pills}
...
# [) 📉 Kaplan-Meier Survival Analysis]{style="color:#000000; font-weight:bold;"} {.tabset .tabset-fade .tabset-pills}
...
**Confident Interval (CI)**: The median OS for the whole cohort is ***34.30 months (~ 3 years)*** with a 95% CI of 27.80 to 41.30 months, indicating a range where I can be 95% confident 🧐 that the true median OS for this HCC cohorts lies somewhere between approximately 28 to 41 months.
...
PFS measures the time from the start of treatment 💊 🕛 until one of the following events occurs:

A) The cancer shows signs of progression (e.g., tumors grow in size or new tumors appear 👹).
...
<span style="color:#0516D3; font-weight:bold;">**Clinical Interpretation:**</span> 👩🏻‍⚕️
...
# [) ☣️ Cox Regression Survival Analysis]{style="color:#000000; font-weight:bold;"} {.tabset .tabset-fade .tabset-pills}
...
# [) 🫣 Summary and Conclusions]{style="color:#000000; font-weight:bold;"} {.tabset}
...
:::::
# <span style="color:#000000; font-weight:bold;">⛴️ Indexes</span> {.unnumbered}
